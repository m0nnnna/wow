INSERT INTO `spell_dbc` SET `ID` = 18173, 
`Category` = 0, 
`DispelType` = 0, 
`Mechanic` = 0, 
`Attributes` = 603981824, 
`AttributesEx` = 0, 
`AttributesEx2` = 4, 
`AttributesEx3` = 256, 
`AttributesEx4` = 0, 
...
`Description_Lang_enUS` = 'Damage done increased by $s1%.
