INSERT INTO `spell_dbc` SET `ID` = 24020, 
`Category` = 0, 
`DispelType` = 0, 
`Mechanic` = 0, 
`Attributes` = 0, 
...
`Description_Lang_enUS` = 'Hurls a massive axe, dealing $s1 damage and stunning the target for $d.', 
