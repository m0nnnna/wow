INSERT INTO `spell_dbc` SET `ID` = 44578, 
`Category` = 0, 
`DispelType` = 0, 
`Mechanic` = 0, 
`Attributes` = 0, 
...
`Description_Lang_enUS` = 'Heals you for $44578s1.', 
...
`AuraDescription_Lang_enUS` = 'Heals you for $44578s1.', 
