...
//        events.ScheduleEvent(EVENT_BRAIN_WASH_TOTEM, 20s);
        events.ScheduleEvent(EVENT_POWERFULL_HEALING_WARD, 25s);
...
//                break;
            case EVENT_POWERFULL_HEALING_WARD:
                ...
                events.ScheduleEvent(EVENT_POWERFULL_HEALING_WARD, 45s, 60s);
                break;
            case EVENT_HEX:
            ...
            case EVENT_TELEPORT:
                ...
                events.ScheduleEvent(EVENT_TELEPORT, 60s, 90s);
                break;
            default:
                break;
            }
